...
def cli():
    ...
    if vad_filter:
        ...
        vad_model = load_vad_model(torch.device(
            device), vad_onset, vad_offset, use_auth_token=hf_token)
    else:
        vad_model = None
    ...
    if diarize:
        ...
        for result, input_audio_path in tmp_results:
            ...
            result = {"segments": results_segments,
